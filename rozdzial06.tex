...
\section{Porównanie metod generowania wektorów}
	...
	\subsection{TF-IDF}\label{sec:tfidf_summary}
		...
		Oba modele \emph{tfidf} osiągają znacznie gorszy wynik od pozostałych, co wskazuje na dużą heterogeniczność zgrupowanych dokumentów.
...
\section{Omówienie wyników poszczególnych metryk}
	...
	Wyniki pomiarów metryką \(C_{UMass}\) przedstawiona została na rysunku~\ref{fig:umass_score} oraz w tabeli z wynikami w rozdziale~\ref{sec:all_scores}.
	...
	Zaskakującym może się wydawać dobry wynik \emph{sbert-default}, jednak należy patrzeć na niego przez pryzmat liczby nieprzypisanych dokumentów.
	Model ten dla przedstawionego zakresu jako szum zaklasyfikował od 185 do 205 tysięcy wypowiedzi.
	Naturalną konsekwencją małej liczby dokumentów w grupach jest ich wysoka spójność, co skutkuje wysokim wynikiem \(C_{UMass}\).
	...
	Weryfikacja spójności dokumentów w grupie sprawia, że metryka należycie porównuje wygenerowane tematy.
