...
\section{Reprezentacja tematu}
	...
	% Możliwe jest dalsze działanie w celu poprawy reprezentacji poprzez lematyzację, jednak wykorzystywany algorytm lematyzujący bazuje na bibliotece \emph{SpaCy},
	% 	która wykorzystuje model TensorFlow do analizy zdania w celu wykrycia części zdania, a dopiero następnie wyboru odpowiedniej bazowej formy słowa.
	% Takie przetwarzanie jest zbyt czasochłonne, aby wykonywać je dla każdego przypadku testowego
