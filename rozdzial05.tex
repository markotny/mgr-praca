...
\section{Ewaluacja spójności reprezentacji tematów}\label{sec:coherence_scores}
	...
	\begin{figure}[htb]
		...
		\caption{Wyniki \(C_{UMass}\) dla parametru n\_neighbors równego 100; }\label{fig:umass_score}
	\end{figure}
	...
	\begin{figure}[htb]
		...
		\caption{Wyniki \(C_{NPMI}\) dla parametru n\_neighbors równego 100}\label{fig:npmi_score}
	\end{figure}
...
\section{Końcowa ocena}
	...
	\begin{figure}
		...
		\caption{Uśrednione wyniki dla wszystkich parametrów}\label{fig:avg_scores}
	\end{figure}
